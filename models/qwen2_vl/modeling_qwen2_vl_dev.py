...
class Qwen2VisionTransformerPretrainedModel_dev(Qwen2VLPreTrainedModel):
    ...
    def forward(
        ...
        Args:
            ...
            exit_level (`Optional[str]`, defaults to `None`):
                ...
                - "low": Runs approx. the first 1/3 of vision layers.
                - "medium": Runs approx. the first 2/3 of vision layers.
                - "high" or `None`: Runs all vision layers (default).
...
class Qwen2VLForConditionalGeneration_dev(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> import requests
        >>> from transformers import AutoProcessor, Qwen2VLForConditionalGeneration_dev

        >>> model = Qwen2VLForConditionalGeneration_dev.from_pretrained("Qwen/Qwen2-VL-7B-Instruct")
